...
Status: blocker-first public GitHub cleanup completed with restricted assets and
...
- [x] Existing intro literature screenshots remain tracked as restricted assets
  to preserve the current presentation.
- [x] No scene code, slide content, or referenced presentation assets were
