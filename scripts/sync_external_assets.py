...
ITEMS: tuple[SyncItem, ...] = (
    ...
    SyncItem(
        ...
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "anchor_images" / "anchor-animal-fish.png",
    ),
    SyncItem(
        "small",
        "file",
    ...
    SyncItem(
        ...
        REPO_ROOT / "assets" / "images" / "study1" / "stage2" / "stimuli_task",
        (
            "LAN-TRP-*.png",
            "PLA-PIE-*.png",
            "BUI-OBS-*.png",
    ...
    SyncItem(
        ...
        REPO_ROOT / "assets" / "images" / "study1" / "stage3" / "memory_task" / "LAN-MOU-T00.png",
    ),
    SyncItem(
        "small",
        "file",
        STABLE_VISUAL_MEMORY_ROOT / "stimuli_task" / "LAN-MOU-D01.png",
        REPO_ROOT / "assets" / "images" / "study1" / "stage3" / "memory_task" / "LAN-MOU-D01.png",
    ),
    SyncItem(
        "small",
        "file",
        STABLE_VISUAL_MEMORY_ROOT / "stimuli_task" / "LAN-MOU-D03.png",
        REPO_ROOT / "assets" / "images" / "study1" / "stage3" / "memory_task" / "LAN-MOU-D03.png",
    ),
    SyncItem(
        "small",
        "file",
    ...
    SyncItem(
        ...
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "exemplar_images" / "animal" / "fish",
    ),
    SyncItem(
        "study1-exemplars",
        "tree",
        SIMILARITY_JUDGMENT_ROOT / "data" / "assets" / "images" / "exemplar_images" / "plant" / "sequoia",
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "exemplar_images" / "plant" / "sequoia",
    ),
    SyncItem(
        "study1-exemplars",
        "tree",
        SIMILARITY_JUDGMENT_ROOT / "data" / "assets" / "images" / "exemplar_images" / "landscape_element" / "lake_island",
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "exemplar_images" / "landscape_element" / "lake_island",
    ),
    SyncItem(
        "study1-exemplars",
        "tree",
        SIMILARITY_JUDGMENT_ROOT / "data" / "assets" / "images" / "exemplar_images" / "building" / "observatory",
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "exemplar_images" / "building" / "observatory",
    ),
    SyncItem(
        "study1-exemplars",
        "tree",
        SIMILARITY_JUDGMENT_ROOT / "data" / "assets" / "images" / "exemplar_images" / "vehicle" / "campervan",
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "exemplar_images" / "vehicle" / "campervan",
    ),
    SyncItem(
        "study1-exemplars",
        "tree",
        SIMILARITY_JUDGMENT_ROOT / "data" / "assets" / "images" / "exemplar_images" / "item" / "sofa",
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "exemplar_images" / "item" / "sofa",
    ),
    SyncItem(
        "study1-interpolations",
        "tree",
        SIMILARITY_JUDGMENT_ROOT / "data" / "assets" / "images" / "fish_interpolations",
        REPO_ROOT / "assets" / "images" / "study1" / "stage1" / "fish_interpolations",
    ),
    SyncItem(
        "study1-reordered",
        "tree",
