...
## media/videos/05_conclusion/{{quality_dir}}/sections/000_conclusion_questions.mp4

- I close by returning to the three questions that organised the dissertation.
- First, are working-memory representations in early visual cortex sensory-like or memory-specific in format.
- Second, does sensory recruitment extend to rich naturalistic stimuli.
- Third, does long-term-memory strengthening modulate the relation between sensory and mnemonic codes.
- I want the conclusion to mirror the structure of the introduction.

## media/videos/05_conclusion/{{quality_dir}}/sections/001_conclusion_summary.mp4
...
## media/videos/05_conclusion/{{quality_dir}}/sections/002_conclusion_results.mp4

- The answer to RQ1 is that working-memory content in early visual cortex is not maintained in a sustained sensory-like format.
- The answer to RQ2 is yes: early visual cortex does carry robust stimulus-specific information for high-resolution naturalistic images during the delay.
- The answer to RQ3 is mixed: repetition improves behaviour, but it does not increase sensory-memory similarity in early visual cortex.
- Together, these results support a refinement rather than a rejection of the sensory recruitment model.

## media/videos/05_conclusion/{{quality_dir}}/sections/003_conclusion_limitations.mp4

- The limitations define the scope of the claims.
...
## media/videos/05_conclusion/{{quality_dir}}/sections/004_conclusion_future_directions.mp4
